    ...
    >
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="跳转外链查看余额URL：" prop="balanceUrl">
            <el-input
              v-model="cardForm.balanceUrl"
              placeholder="请输入跳转外链查看余额URL"
              maxlength="255"
            />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24">
          <el-form-item label="会员卡颜色：" prop="color">
            <el-input
              ...
              placeholder="请输入会员卡颜色，填写Color010-Color100"
              maxlength="100"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="卡券使用提醒：" prop="notice">
            <el-input
              v-model="cardForm.notice"
              placeholder="请输入卡券使用提醒，字数上限为16个汉字"
              maxlength="100"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="跳转外链的入口名字：" prop="customUrlName">
            <el-input
              v-model="cardForm.customUrlName"
              placeholder="请输入跳转外链的入口名字"
              maxlength="100"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="跳转外链的URL：" prop="customUrl">
            <el-input
              v-model="cardForm.customUrl"
              placeholder="请输入跳转外链的URL"
              maxlength="255"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item
            label="显示在入口右侧的提示语："
            prop="customUrlSubTitle"
          >
            <el-input
              v-model="cardForm.customUrlSubTitle"
              placeholder="请输入显示在入口右侧的提示语"
              maxlength="100"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="24">
          ...
          >
            <el-input
              v-model="cardForm.prerogative"
              type="textarea"
              rows="2"
              placeholder="请输入会员卡特权说明，字数上限为1024个汉字"
              maxlength="255"
            />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24">
          ...
          >
            <el-input
              ...
              type="textarea"
              rows="4"
              placeholder="请输入卡券使用说明，字数上限为1024个汉字"
              maxlength="255"
            />
          </el-form-item>
        </el-col>
