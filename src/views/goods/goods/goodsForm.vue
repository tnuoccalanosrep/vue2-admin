              ...
              <el-row>
                <el-col :span="24">
                  <el-form-item label="商品条码" prop="goodsNo">
                    <el-input
                      class="input"
                      v-model="baseForm.goodsNo"
                      placeholder="请输入商品条码，或使用扫码枪扫描"
                      maxlength="50"
                    />
                    <div class="create-sn" @click="createGoodsSn()">
                      随机生成条码
                    </div>
                  </el-form-item>
                </el-col>
        ...
        <el-tab-pane label="扩展信息" name="extend">
          <div class="content">
            ...
            >
                ...
                <el-col :span="24">
                  <el-form-item label="划线价格" prop="linePrice">
                    <el-input
                      ...
                      class="min-input"
                      placeholder="请输入商品划线价格（市场价），空则不显示"
                      maxlength="50"
                    />
                    <div class="form-tips">单位：元</div>
                  </el-form-item>
              ...
              <el-row
                v-if="
                  extendForm.isSingleSpec == 'Y' && baseForm.type == 'goods'
                "
              >
                <el-col :span="24">
    ...
    getGoodsInfo(goodsId) {
      ...
      getGoodsInfo(goodsId).then((response) => {
        ...
        if (goodsInfo) {
          ...
          this.baseForm.storeId = goodsInfo.storeIds
            ? goodsInfo.storeIds.split(',')
            : []
          ...
          this.extendForm.canUsePoint =
            goodsInfo.canUsePoint == null ? 'Y' : goodsInfo.canUsePoint
          this.extendForm.isMemberDiscount =
            goodsInfo.isMemberDiscount == null
              ? 'Y'
              : goodsInfo.isMemberDiscount
          this.extendForm.isSingleSpec =
            goodsInfo.isSingleSpec == null ? 'Y' : goodsInfo.isSingleSpec
