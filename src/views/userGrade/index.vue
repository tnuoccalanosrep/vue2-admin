  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="升级方式" prop="catchType">
        ...
        >
          <el-option
            v-for="catchType in catchTypeList"
            :key="catchType.key"
            :label="catchType.name"
            :value="catchType.key"
          />
        </el-select>
      </el-form-item>
    ...
    >
      ...
      <el-table-column label="有效天数" align="center" prop="validDay">
        <template slot-scope="scope">
          <span v-if="scope.row.validDay > 0">{{
      ...
      <el-table-column label="支付折扣" align="center" prop="discount">
        <template slot-scope="scope">
          <span v-if="scope.row.discount > 0">{{
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="升级条件值" prop="catchValue">
              <el-input
                v-model="form.catchValue"
                placeholder="请输入升级条件值，单位可能是元、次"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="24">
            <el-form-item label="有效天数" prop="validDay">
              <el-input
                ...
                placeholder="请输入有效天数，如30，0表示永久有效"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
